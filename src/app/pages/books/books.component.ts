...
categoryListSubscription!: Subscription; // Subscription for fetched books
categoryList:any[] = []; // this variable contains all of required books
...
ngOnInit():void{
  ...
  */
  ...
  this.categoryListSubscription = this.api.get('categories').subscribe(books => {
    this.categoryList = books.data.filter((book: Book) => book.type == this.activeCategory);
